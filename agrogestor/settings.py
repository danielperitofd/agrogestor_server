...
# === Arquivos EstÃ¡ticos (CSS, JS, imagens fixas) ===
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# === Arquivos de MÃ­dia (imagens de perfil, uploads) ===
MEDIA_URL = '/media/'
...
INSTALLED_APPS = [
    ...
    'dashboard',  # ðŸ‘ˆ Adicionamos aqui
    'widget_tweaks', # ?? Adicionamos aqui
...
WSGI_APPLICATION = 'agrogestor.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = [
    'https://agrogestor.miroutepe.com.br',
    'https://www.agrogestor.miroutepe.com.br',
]
